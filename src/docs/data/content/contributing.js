...
Thanks for wanting to improve Readmade. The project is local-first and intentionally small, so focused changes are easiest to review.
...
Be respectful and constructive. Harassment or personal attacks are not acceptable in issues, pull requests, or discussions.

## Security issues

Do not open a public issue for security problems. Follow the [security policy](/docs/security) instead.

## License

By contributing, you agree that your contributions are licensed under the [MIT License](/docs/license).
