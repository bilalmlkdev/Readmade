export const inputCls = "w-full px-3 py-2 text-[13px] bg-white dark:bg-[#1a1a1a] dark:text-white border border-gray-200 dark:border-white/10 rounded-lg focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-black dark:focus:ring-white placeholder:text-gray-400";

export const inputFlexCls = "flex-1 px-3 py-2 text-[13px] bg-white dark:bg-[#1a1a1a] dark:text-white border border-gray-200 dark:border-white/10 rounded-lg focus:outline-none focus:border-gray-300 focus:ring-1 focus:ring-black dark:focus:ring-white placeholder:text-gray-400";
...
export const removeBtnCls = "text-[12px] font-medium text-red-500 hover:text-red-600";
export const removeIconCls = "p-1.5 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded";
export const cardCls = "space-y-2 p-3 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/10 rounded-lg";
