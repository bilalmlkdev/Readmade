...
export default function PreviewFooter({ kbSize, validScreenshots, wordCount }) {
  return (
    <div className="border-t border-gray-200 sticky bottom-0 bg-white px-3 py-2 flex items-center justify-between gap-4 text-[9px] sm:text-[10px] text font-bold">
