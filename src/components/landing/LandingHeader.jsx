      ...
      <div className="mx-auto flex h-14 max-w-[100%] items-center justify-between px-15">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[13px] text-gray-500 transition hover:text-black dark:text-gray-400 dark:hover:text-white"
          >
          ...
          <Link
            to="/app"
            className="ml-1 inline-flex items-center bg-black px-3 py-1.5 text-[13px] text-white dark:bg-white dark:text-black transition hover:bg-black/90 dark:hover:bg-white/90"
          >
            Open App
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center p-1.5 text-gray-500 transition hover:text-black dark:text-gray-400 dark:hover:text-white"
          >
          ...
          <Link
            to="/app"
            className="inline-flex items-center bg-black px-3 py-1.5 text-[13px] font-medium text-white dark:bg-white dark:text-black transition hover:bg-black/90 dark:hover:bg-white/90"
          >
            Open App
          </Link>
        </div>
