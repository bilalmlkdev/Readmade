...
export default function ScreenshotSection() {
  return (
    <section className="px-15 pb-24 bg-[#FAFAFA]">
      <div className="mx-auto max-w-full">
        <figure className="m-0 grid grid-cols-1 gap-5 lg:grid-cols-12 lg:gap-8">
          <figcaption className="order-2 m-0 flex items-end text-[13px] leading-relaxed text-gray-400 lg:order-1 lg:col-span-5 lg:max-w-sm">
          ...
          <div className="order-1 overflow-hidden border border-gray-200 lg:order-2 lg:col-span-7">
            <img
              src={dashboardImg}
