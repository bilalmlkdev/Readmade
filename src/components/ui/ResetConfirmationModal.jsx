  ...
  return (
    ...
    >
      <div
        ...
        role="dialog" aria-modal="true" aria-labelledby="reset-modal-title" aria-describedby="reset-modal-description" className="bg-white dark:bg-[#161616] rounded-xl shadow-2xl shadow-black/10 border border-gray-200 dark:border-white/10 max-w-[360px] w-full mx-4 p-5 outline-none"
      >
        <h3
          id="reset-modal-title" className="text-[15px] font-semibold text-gray-900 dark:text-white mb-1.5"
        >
          Reset workspace?
        </h3>
        <p
          id="reset-modal-description" className="text-gray-500 dark:text-gray-400 text-[13px] leading-relaxed mb-5"
        >
