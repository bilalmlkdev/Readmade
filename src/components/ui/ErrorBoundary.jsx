    ...
    if (this.state.hasError) {
      return (
        <main className="min-h-screen w-full flex flex-col items-center justify-center px-6 text-center" style={{ background: "var(--bg)" }}>
          ...
          <p className="mt-4 text-base text-black max-w-sm leading-relaxed">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center gap-3">
            <button
              ...
              className="inline-flex items-center px-2 py-1.5 bg-black text-white text-[14px] font-medium hover:bg-black/90 transition-colors rounded-lg shadow-xs"
            >
              Reload
            </button>
            <Link
              to="/"
              className="inline-flex items-center bg-gray-200 rounded-lg px-2 py-1.5 text-[14px] font-medium text-gray-500 hover:text-black transition-colors"
            >
              Back to Readmade
            </Link>
          </div>
