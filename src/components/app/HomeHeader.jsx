  ...
  return (
    <header className="hidden app:flex items-center justify-between h-15 px-4 shrink-0 bg-white dark:bg-[#111] border-b border-gray-200 dark:border-white/10">
      <div className="flex items-center gap-4">
        <a
          href="/" className="flex items-center gap-1.5 text-[13.5px] font-medium text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white"
        >
          <ArrowLeft size={16} />
          Back
        </a>
      ...
      <div className="flex items-center gap-2">
        <a
          href={REPO_URL}
          target="_blank" rel="noreferrer" className="flex items-center gap-1.5 px-2 py-1.5 text-[13px] font-medium text-gray-500 hover:text-black hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-white/10 rounded-lg" title="GitHub stars"
        >
          <svg
        ...
        <button
          onClick={onHistory}
          className="flex items-center gap-1.5 px-2 py-1.5 text-[13px] font-medium text-gray-500 hover:text-black hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-white/10 rounded-lg" title="History"
        >
          <History size={14.5} />
          History
        </button>
